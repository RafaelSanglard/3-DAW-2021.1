    ...
    <script> 
        function mostraInfo(strUF) {
            ...
            if (strUF.length > 0) {
                ...
                xmlHttp.open("GET", "http://localhost/3daw/outros/getcidades.php?estado=" + strUF, true);
                xmlHttp.send();
        ...
        function inserirProd() {
            let objProd = document.getElementById("formProd");          
                ...
                xmlHttp.open("GET", "http://localhost/3daw/outros/inserirproduto.php?id=" + objProd.id.value +
...
<form action="" method="post" name="Pod" id="formProd">
    ...
    <input type="button" name="op" value="InserirProduto" onclick="inserirProd()">
</form>
<p id="resposta"></p>
